...
var compileObject = function compileObject(form) {
  ...
  isVector(form) ?
    compile(applyForm(symbol("vector"), list.apply(list, form))) :
  isList(form) ?
    compile(applyForm(symbol("list"), form)) :
  isDictionary(form) ?
