...
require.define("/lib/list.js",function(require,module,exports,__dirname,__filename,process){var isString = (require("./runtime")).isString;
...
var isSelfEvaluating = function(form) {
  return ((Object.prototype.toString.call(form) === '[object Number]') || (((Object.prototype.toString.call(form) === '[object String]') && !isSymbol(form)) || ((typeof(form) === "boolean") || ((form == null) || (isKeyword(form) || isRePattern(form))))));
};
...
var compileObject = function(form) {
  ...
  isRePattern(form) ? (compileRePattern(form)) :
...
var compileReference = function(form) {
  ...
  id = id.split("-").reduce(function(result, key) {
    return ''.concat(result, (!isEmpty(result) && !isEmpty(key)) ?
...
var defineBindings = function(form) {
...
var rebindBindings = function(names, values) {
  return (function loop(result, names, values) {
    var recur = loop;
    while ((recur === loop)) {
      recur = isEmpty(names) ?
        reverse(result) :
        (result = cons(list(symbol("set!"), first(names), first(values)), result),
         names = rest(names),
         values = rest(values),
         loop)
    };
...
var expandRecur = function(names, body) {
...
var compileRecur = function(names, body) {
...
var compileRePattern = function(form) {
  return ''.concat(form);
};
