...
require.define("/lib/list.js",function(require,module,exports,__dirname,__filename,process){var List = function List(head, tail) {
  this.head = head;
  this.tail = tail;
...
var reduceList = function reduceList(form, f, initial) {
  return (function loop() {
    var result = typeof(initial) === "undefined" ?
      first(form) :
      initial;
    var items = typeof(initial) === "undefined" ?
      rest(form) :
      form;
...
var sortList = function sortList(items, f) {
  return list.apply(list, listToVector(items).sort(typeof(f) === "undefined" ?
    f :
    function(a, b) {
      return f(a, b) ?
        0 :
